...
\begin{document}
	...
	%\calVisualColorido{1}{\DIAUM}{\DIADOIS}{\ANO}{06-30} % semestre, dias de aula (DOIS vezes por semana)
...
\small
%\footnotesize
\begin{calendar}{7/31/\ANO}{21} % Semestre comeca no dia 1 de agosto, e dura por 21 semanas.
...
\caltextnext{Concorrência: semáforos e monitores (Cap. 13)}
